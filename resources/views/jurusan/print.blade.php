...
<head>
    ...
    <title>Cetak Data Jurusan - Cyber City University</title>
    <style>
        body {
...
<body onload="window.print()">
    ...
    <div class="kop-container">
        <div class="kop-logo">
            <img src="data:image/jpeg;base64,{{ base64_encode(file_get_contents(public_path('images/logo.jpg'))) }}" alt="Logo">
        </div>
        <div class="kop-teks">
            ...
            <div class="detail-kontak">
                Pusat Pengembangan Mutu Akademik — Kampus Utama Terpadu<br>
    ...
    <div class="judul-laporan">Laporan Data Program Studi & Akreditasi</div>
    <div class="sub-judul-laporan">Tahun Akademik {{ date('Y') }}/{{ date('Y') + 1 }} — Biro Penjaminan Mutu Internal (BPMI)</div>
    ...
    <table class="data-table">
        <thead>
            <tr>
                ...
                <th width="20%" class="text-center">Total Mahasiswa</th>
                <th width="20%" class="text-center">Total Matakuliah</th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center badge-cetak">{{ $j->akreditasi }}</td>
                <td class="text-center">{{ $j->mahasiswas->count() }} Orang</td>
                <td class="text-center">{{ $j->matakuliahs->count() }} MK</td>
            </tr>
            @empty
            <tr>
                <td colspan="5" style="text-align:center; padding:20px; color:#64748b;">
                    Belum ada data program studi / jurusan yang terdaftar.
                </td>
            </tr>
            @endforelse
        </tbody>
